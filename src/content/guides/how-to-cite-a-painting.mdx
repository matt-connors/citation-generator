...
<CitationExampleTable
  ...
  overrides={{
    'mla-9': 'Van Gogh, Vincent. <em>The Starry Night</em>. 1889. <em>MoMA</em>, https://www.moma.org/learn/moma_learning/vincent-van-gogh-the-starry-night-1889/.',
...
- **MLA:** (Van Gogh) — the citation keys to the works-cited entry, and an artwork has no page number to add. MLA capitalizes Van when the surname stands alone, unlike APA.
