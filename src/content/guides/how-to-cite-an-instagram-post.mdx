...
<TryGenerator heading="Cite your Instagram post now" blurb="Paste the post or Reel link and get an MLA works-cited entry built from the account name, caption, and date, with APA and five more styles one click away." tab="website" placeholder="Paste the Instagram post URL" style="mla-9" from="how-to-cite-an-instagram-post" />
