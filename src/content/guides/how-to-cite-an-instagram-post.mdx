...
<CitationExampleTable
  source={{ id: 'instagram-example', type: 'webpage', title: 'Male depression is serious, but many men try to ignore it or refuse treatment. Different men have different symptoms, but', author: [{ literal: 'APA Public Interest Directorate' }], 'container-title': 'Instagram', issued: { 'date-parts': [[2019, 6, 14]] }, accessed: { 'date-parts': [[2026, 7, 4]] }, URL: 'https://www.instagram.com/p/BysOqenB1v7/', custom: { social: { platform: 'instagram', handle: 'apapubint', displayName: 'APA Public Interest Directorate', kind: 'video' } } }}
  overrides={{
