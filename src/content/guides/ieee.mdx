---
title: 'IEEE Citation Guide for Engineering and Computer Science'
pubDate: 2026-05-27
updatedDate: 2026-07-01
description: 'Complete IEEE citation guide for bracketed in-text numbers, ordered references, technical source examples, and engineering paper formatting.'
...
IEEE is the citation style of electrical engineering, computer science, telecommunications, and signal processing. The variant [this site generates](/ieee-citation-generator/) is **IEEE Reference Guide version 11.29.2023** — the current edition used in IEEE Transactions journals and at IEEE conferences. If your conference paper template, journal author kit, or course syllabus says "IEEE," this is the style you want.
