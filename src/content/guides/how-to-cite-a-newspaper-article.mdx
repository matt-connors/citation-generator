...
<TryGenerator heading="Cite your newspaper article now" blurb="Paste the article's link and get an MLA works-cited entry built from its byline, headline, and date, with APA and five more styles one click away." tab="website" placeholder="Paste the article URL" style="mla-9" from="how-to-cite-a-newspaper-article" />
