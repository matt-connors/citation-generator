---
title: 'How to Cite a PDF in MLA, APA, Chicago & 4 More Styles'
pubDate: 2026-05-13
updatedDate: 2026-07-04
description: 'How to cite PDFs in MLA, APA, Chicago, Harvard, Vancouver, IEEE, and AMA, with examples for reports, white papers, scans, and login-only files.'
category: 'how-to'
keywords: ['how to cite a PDF', 'how to cite a PDF in MLA', 'cite a PDF MLA', 'cite a PDF APA', 'PDF citation', 'cite a government report', 'cite a white paper', 'cite a working paper', 'PDF reference format']
tags: ['PDFs', 'reports', 'white papers', 'government documents', 'citations', 'MLA', 'APA', 'Chicago', 'Harvard', 'Vancouver', 'IEEE', 'AMA']
relatedGuides: ['mla', 'apa', 'chicago', 'harvard', 'how-to-cite-a-website', 'how-to-cite-a-journal-article', 'how-to-cite-a-lecture']
faq:
