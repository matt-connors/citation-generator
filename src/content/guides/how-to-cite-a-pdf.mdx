...
pubDate: 2026-05-13
description: 'How to cite PDFs in APA, MLA, Chicago, Harvard, Vancouver, IEEE, and AMA, with examples for reports, white papers, scans, and login-only files.'
category: 'how-to'
...
relatedGuides: ['apa', 'mla', 'chicago', 'harvard', 'how-to-cite-a-website', 'how-to-cite-a-journal-article', 'how-to-cite-a-lecture']
faq:
