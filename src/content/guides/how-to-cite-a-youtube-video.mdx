...
faq:
  ...
  - question: 'Should I include the video''s length in the citation?'
    answer: 'Chicago author–date allows the duration as part of the format note ("YouTube video, 14:32."). MLA, APA, and the numeric styles do not require duration — the type designator ("uploaded by" in MLA, "[Video]" in APA) is enough. Including duration when not required is not wrong; it just adds noise.'
cite:
  sourceType: 'youtube'
  style: 'mla-9'
