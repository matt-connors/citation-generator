...
faq:
  ...
  - question: 'Should I include the video''s length in the citation?'
    answer: 'Chicago author–date includes the duration as part of the format note: "YouTube video, 14:32." APA, MLA, and the numeric styles do not require duration — the type designator ("[Video]" in APA, "uploaded by" in MLA) is enough. Including duration when not required is not wrong; it just adds noise.'
...
- **APA, Chicago author–date, Harvard:** (Lin, 2024, 4:32)
- **MLA:** (Lin 4:32)
