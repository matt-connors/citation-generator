---
title: 'Works Cited vs. Bibliography vs. References: What to Call Your Source List'
pubDate: 2026-04-29
description: 'The difference between a Works Cited, References, and Bibliography section — what each name means, what goes in each, and which one your style requires. Includes a per-style table mapping the right heading. Written and reviewed by the MLA Generator Editorial Team.'
category: 'concept'
