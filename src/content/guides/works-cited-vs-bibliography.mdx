...
faq:
  ...
  - question: 'Which name does my style require?'
    answer: 'MLA uses "Works Cited." APA, Harvard (Cite Them Right), and Chicago author–date use "References." Chicago notes–bibliography uses "Bibliography" — and traditionally permits consulted-but-not-cited sources. Vancouver, IEEE, and AMA use "References." The heading is required to match the style; using "Bibliography" on an APA paper is a recognizable error.'
  ...
  - question: 'Should the heading say "Works Cited," "References," or "Bibliography" centered or left-aligned?'
    answer: 'Every style centers the heading at the top of its own page, in the same font as the body, neither bolded nor italicized. APA, MLA, and Chicago all specify this. The heading is the only line on that line — no underline, no decorative formatting. The reference entries start on the next line, double-spaced or following the manuscript''s spacing convention.'
