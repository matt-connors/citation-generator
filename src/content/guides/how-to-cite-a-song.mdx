...
**A featured artist.** Credit the artists as the release credits them. APA joins collaborators with an ampersand — Coldplay & BTS — and their labels with semicolons. Chicago-aligned discographies put the guest after the track title: "Umbrella," featuring Jay-Z, track 1 on Rihanna, *Good Girl Gone Bad*, Island Def Jam, 2007, Spotify. In MLA, open the entry with the lead artist as the release lists them, and name the guest in your prose if the feature matters to your argument.
