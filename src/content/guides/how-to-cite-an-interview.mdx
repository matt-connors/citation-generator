---
title: 'How to Cite an Interview in MLA, APA, Chicago & 4 More Styles'
pubDate: 2026-05-22
updatedDate: 2026-07-04
description: 'How to cite interviews in MLA, APA, Chicago, Harvard, Vancouver, IEEE, and AMA, including personal, podcast, broadcast, email, and published interviews.'
category: 'how-to'
keywords: ['how to cite an interview', 'how to cite an interview in mla', 'cite interview APA', 'cite interview MLA', 'interview citation', 'cite personal interview', 'cite podcast interview', 'cite email correspondence', 'personal communication citation']
tags: ['interviews', 'personal communications', 'podcasts', 'broadcast', 'citations', 'APA', 'MLA', 'Chicago', 'Harvard', 'Vancouver', 'IEEE', 'AMA']
relatedGuides: ['apa', 'mla', 'chicago', 'how-to-cite-a-youtube-video', 'how-to-cite-a-website', 'in-text-citations', 'how-to-cite-a-lecture']
faq:
