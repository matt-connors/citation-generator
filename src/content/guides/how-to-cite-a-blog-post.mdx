...
<TryGenerator sourceType="blog" heading="Cite your blog post now" blurb="Paste the post's link from Medium, Substack, WordPress, or any blog and get an MLA works-cited entry, with APA and five more styles one click away." tab="website" placeholder="Paste the blog post URL" style="mla-9" from="how-to-cite-a-blog-post" />
