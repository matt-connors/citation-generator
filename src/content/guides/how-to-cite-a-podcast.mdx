---
title: 'How to Cite a Podcast in MLA, APA & Chicago'
pubDate: 2026-06-27
updatedDate: 2026-07-04
description: 'How to cite podcast episodes in MLA, APA, and Chicago, including host roles, episode titles, show names, dates, URLs, and worked examples.'
category: 'how-to'
keywords: ['how to cite a podcast', 'how to cite a podcast in mla', 'cite podcast MLA', 'cite podcast APA', 'cite podcast Chicago', 'podcast citation', 'cite a podcast episode', 'audio podcast episode citation']
...
cite:
  sourceType: 'podcast'
  style: 'mla-9'
  heading: 'Cite your podcast episode now'
  blurb: 'Paste the episode page''s link and the generator builds the reference in your chosen style.'
---

A podcast episode is one of the more structured sources you will cite: it has a host who acts like an author, an episode title that behaves like a chapter, a show that behaves like a book or journal, a release date, and a URL. Get those five pieces in the right slots and the citation falls into place in any style. This guide walks through citing a single **episode** — the unit you almost always quote — in [MLA 9](/guides/mla/), [APA 7](/guides/apa/), and [Chicago 18](/guides/chicago/), with one correct worked example per style.
