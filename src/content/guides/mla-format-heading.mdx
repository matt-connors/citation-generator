...
description: 'How to format the MLA heading: the four-line first-page block, the running header with your last name and page number, the centered title, and whether MLA needs a title page.'
category: 'how-to'
