---
title: 'Chicago Notes-Bibliography vs Author-Date'
pubDate: 2026-03-04
description: 'Compare Chicago notes-bibliography and author-date systems, including in-text format, footnotes, bibliography headings, and when each one is used.'
category: 'comparison'
