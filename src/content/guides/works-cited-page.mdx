...
description: 'Build an MLA Works Cited page with alphabetical order, half-inch hanging indents, double spacing, headings, and a worked example list.'
category: 'how-to'
...
relatedGuides: ['mla', 'works-cited-vs-bibliography', 'hanging-indents', 'research-and-works-cited', 'mla-multiple-works-same-author']
faq:
