---
title: 'How to Cite a Book in APA, MLA, Chicago, and Four More Styles'
pubDate: 2026-04-15
description: 'How to cite a book in all seven major citation styles — APA, MLA, Chicago, Harvard, Vancouver, IEEE, and AMA. The same single-author book and a chapter in an edited book formatted side by side in every style, plus rules for editions, translations, e-books, and books with no named author. Written and reviewed by the MLA Generator Editorial Team.'
category: 'how-to'
keywords: ['how to cite a book', 'cite a book APA', 'cite a book MLA', 'book citation', 'cite a chapter in a book', 'cite an edited book', 'how to cite a translated book', 'how to cite an ebook']
...
faq:
  - question: 'Do I need to include the publisher city for a book?'
    answer: 'It depends on the style. APA 7 dropped publisher location in 2019, so APA references no longer include the city. AMA 11 made the same change. MLA, Chicago, Harvard, Vancouver, and IEEE still include the city of publication before the publisher name, separated by a colon. For ambiguous city names — Cambridge, Springfield, Portland — most styles add the country or U.S. state to disambiguate.'
  ...
  - question: 'How do I cite a book with multiple authors?'
    answer: 'Up to about three authors, list every name. With more, the threshold for using "et al." varies: APA 7 uses et al. starting at three authors in-text but lists up to 20 in the reference list before using an ellipsis. MLA uses et al. starting at three authors in both places. Chicago uses et al. starting at four authors in-text and lists up to ten in the reference list. Harvard (Cite Them Right) uses et al. starting at four authors. Vancouver, IEEE, and AMA each have their own thresholds — check the dedicated style guide.'
...
The visible differences are predictable. APA and AMA omit the publisher city — both styles dropped it in their most recent editions. The other five styles still include it. APA, Harvard, and Vancouver use lowercase (sentence case) for the title; MLA, Chicago, IEEE, and AMA use title case. APA, MLA, Chicago, Harvard, and IEEE italicize the title; Vancouver and AMA do not — though AMA italicizes book titles when standing alone in a reference, which is the case here. Year placement varies: APA and Harvard parenthesize it after the author; MLA, Chicago, IEEE, and AMA push it later; Vancouver puts it after the publisher with a semicolon.

The in-text citation for the same source:

- **APA, Chicago author–date, Harvard:** (Chen, 2021) — add a page number when quoting: (Chen, 2021, p. 47)
- **MLA:** (Chen 47)
