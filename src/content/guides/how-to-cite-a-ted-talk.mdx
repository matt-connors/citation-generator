...
faq:
  ...
  - question: 'Is the author of a TED Talk citation the speaker or TED?'
    answer: 'It depends on where you watched it. On ted.com, both MLA and APA make the speaker the author. On YouTube, APA switches the author to the uploading account (TED or TEDx Talks) to aid retrieval and keeps the speaker''s name inside the video title; MLA keeps the speaker as author when they are identifiable and records the channel as "uploaded by TED" after the container.'
