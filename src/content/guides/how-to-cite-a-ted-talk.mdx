...
<TryGenerator sourceType="ted" heading="Cite your TED Talk now" blurb="Paste the talk's ted.com or YouTube link and get an MLA works-cited entry built from the speaker, title, and date, with APA and five more styles one click away." tab="website" placeholder="Paste the TED Talk URL" style="mla-9" from="how-to-cite-a-ted-talk" />
