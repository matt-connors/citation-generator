...
relatedGuides: ['how-to-cite-a-doi', 'apa', 'vancouver', 'ieee', 'ama', 'how-to-cite-a-book', 'how-to-cite-a-pdf']
faq:
...
The [generator at /](/) on this site captures most of these fields from a DOI. As always, verify the result against the article's actual landing page - a stale issue number or wrong page range is the most common error in machine-extracted citations.
