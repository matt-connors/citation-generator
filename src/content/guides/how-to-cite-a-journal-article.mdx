...
faq:
  ...
  - question: 'What is the difference between citing the print version and the online version of a journal article?'
    answer: 'For most styles, none — the citation is the same regardless of how you read it, because the article itself is the same. The article''s DOI is the link to the canonical version, online or off. Where the styles differ on this is in their access-date policy: APA and Chicago omit access dates for stable, DOI-bearing articles; MLA, Harvard, Vancouver, AMA, and IEEE include the access date for any web-accessed article, DOI or not.'
...
The structural pattern is the same in every style — authors, title, journal, year, volume, issue, pages, DOI — and the punctuation around each piece is where they diverge. APA, MLA, Chicago, and Harvard spell out the full journal name and italicize it. Vancouver, AMA, and IEEE use NLM-style abbreviations (Index Medicus): *Journal of Cognitive Development* becomes *J Cogn Dev*. IEEE abbreviates further, including the words in the article title, though American IEEE journals are less aggressive about this than older European technical journals.
...
- **APA, Chicago author–date, Harvard:** (Goldstein et al., 2024)
