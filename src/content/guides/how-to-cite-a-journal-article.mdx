...
description: 'How to cite journal articles in MLA, APA, Chicago, Harvard, Vancouver, IEEE, and AMA, including DOIs, preprints, retractions, and online-only articles.'
category: 'how-to'
keywords: ['how to cite a journal article', 'how to cite a journal article in mla', 'cite journal article MLA', 'cite journal article APA', 'journal article citation', 'DOI citation', 'preprint citation', 'retracted article citation', 'online journal article']
tags: ['journal articles', 'peer-reviewed', 'DOI', 'citations', 'MLA', 'APA', 'Chicago', 'Harvard', 'Vancouver', 'IEEE', 'AMA']
...
faq:
  - question: 'Do I need a DOI in a journal article citation?'
    answer: 'Yes, whenever the article has one. Every modern style requires the DOI in the reference list entry when it exists, formatted as a clickable URL (https://doi.org/10.xxx/yyy) in MLA, APA, Chicago, and Harvard; as the bare DOI with a "doi:" prefix and no space in Vancouver and AMA ("doi:10.xxx/yyy"); and with a "doi:" prefix and a space in IEEE ("doi: 10.xxx/yyy"). For articles too old to have a DOI, use the article''s URL on the journal''s site, with the appropriate access date for the styles that require one.'
  ...
  - question: 'Should I abbreviate the journal name?'
    answer: 'In Vancouver, AMA, and IEEE, yes — they all use Index Medicus / NLM-style abbreviations. *Journal of Cognitive Development* becomes *J Cogn Dev*. In MLA, APA, Chicago, and Harvard, no — these styles use the full journal title in italics, exactly as the journal publishes it. If your target journal''s instructions specify a different practice, follow those instructions.'
  - question: 'What is the difference between citing the print version and the online version of a journal article?'
    answer: 'For most styles, none — the citation is the same regardless of how you read it, because the article itself is the same. The article''s DOI is the link to the canonical version, online or off. Where the styles differ on this is in their access-date policy: MLA, APA, and Chicago omit access dates for stable, DOI-bearing articles, treating the DOI as a permanent identifier; Harvard (Cite Them Right), Vancouver, AMA, and IEEE include the access date for any web-accessed article as a matter of convention.'
cite:
  sourceType: 'journal'
  style: 'mla-9'
  heading: 'Cite your journal article now'
  blurb: 'Paste the article''s DOI and the generator pulls the authors, title, journal, and issue into a formatted entry.'
---
...
- **Journal title** — full title for MLA/APA/Chicago/Harvard; NLM abbreviation for Vancouver/AMA/IEEE.
