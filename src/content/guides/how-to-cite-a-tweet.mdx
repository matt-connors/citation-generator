...
<TryGenerator sourceType="x-post" heading="Cite your tweet or X post now" blurb="Paste the post's URL and the generator pulls the handle, text, and date into a formatted MLA entry — switch the dropdown for APA and five more styles." tab="website" placeholder="Paste the post's URL" style="mla-9" from="how-to-cite-a-tweet" />
