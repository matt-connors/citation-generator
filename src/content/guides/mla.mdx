...
The [Works Cited page](/guides/works-cited-vs-bibliography) goes on its own page at the end of the paper, with the words **Works Cited** centered at the top — not bolded, not underlined, just centered in the same font as the rest of the paper. This is a small but visible difference from APA's bold "References." Every source cited in the body appears here, and every entry here is cited at least once in the body.
