...
[MLA 9](/guides/mla/) gives you two tracks, and knowing both saves you from library guides that only show one. Appendix 2 of the handbook says student papers citing a handful of government documents may treat them "just like any other source written by an organization," recording the agency's name as the source presents it. Research and legal-heavy writing standardizes instead: pyramid the name from the largest unit down, comma-separated, starting with the government itself — "United States, Department of Health and Human Services, National Institutes of Health."
